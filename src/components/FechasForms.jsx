      ...
      <Col span={24}>
        <Controller
          ...
          rules={{
            ...
            pattern: {
              value: /^[0-4]$/,
              message: "El maxmimo de personas por habitacion es 4",
            },
          }}
          render={({ field }) => (
            <Form.Item
              ...
              validateStatus={errors.Data?.personasTotal ? "error" : "success"}
              help={
                errors.Data?.personasTotal && errors.Data?.personasTotal.message
              }
            >
              <Input {...field} />
            </Form.Item>
